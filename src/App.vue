<!--* Espacio HTML que contiene el navbar y footer como plantilla reutilizable -->
<template>
  <div class="main-container"> 
    ...
    <!--! Lugar donde se llama los componentes de vue -->
    <main class="content">
      <router-view />
    </main>
...
<!--* Uso de JS para hacer la conexión con el resto de archivos (componente vue sobre todo) -->
  <script setup>
...
<!--* Estilos CSS pero SOLO para el navbar y footer -->
<style>
...
.nav-link:hover {
  color: #1e3c50;
  background-color: rgb(61 30 172 / 0.1);
}
